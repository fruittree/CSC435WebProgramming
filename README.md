...
------- | ---------------- | ---------- | ---------:
|Tuesday, Jan 15 | Internet and Web | Getting Started With The Web (https://www.google.com)| Homework 1 Out|
|Friday, Jan 18 | HTML | Intro to HTML (https://developer.mozilla.org/en-US/docs/Learn/HTML)|Creative Project|